...
> Lineage: 1 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 2 · Changelog: fresh (18 d)
...
| Pkg folder | [packages\user-consents](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\user-consents) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package user-consents -Apply
