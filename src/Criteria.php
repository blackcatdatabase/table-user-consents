...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'user_id', 'consent_type', 'version', 'granted', 'granted_at', 'source', 'meta' ];
    }
    ...
    {
        $x = [ 'id', 'user_id', 'consent_type', 'version', 'granted', 'granted_at', 'source' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\UserConsents\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\UserConsents\Definitions::softDeleteColumn();
