...
final class UserConsentsModule implements ModuleInterface
{
    public function name(): string { return 'table-user_consents'; }
    public function table(): string { return 'user_consents'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_user_consents_user', 'ux_user_consents' ];
        if ($d->isMysql()) {
        ...
        $expectedFk  = [ 'fk_user_consents_user' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_user_consents_user', 'ux_user_consents' ],
            'foreignKeys' => [ 'fk_user_consents_user' ],
        ];
    }
}
