...
namespace BlackCat\Database\Packages\UserConsents\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO UserConsentDto:
...
final class UserConsentDtoMapper
{
    ...
    /** @var string[] */
    private const DATE_COLS   = [ 'granted_at' ];
    /** @var string[] */
     ...
     */
    public static function fromRow(array $row): UserConsentDto
    {
        /** @var UserConsentDto */
    ...
    public static function fromRowOrNull(?array $row): ?UserConsentDto
    {
     ...
     *
     * @param UserConsentDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(UserConsentDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(UserConsentDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(UserConsentDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,UserConsentDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,UserConsentDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(UserConsentDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,UserConsentDto>
     */
