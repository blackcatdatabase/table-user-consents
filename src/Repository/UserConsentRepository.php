...
final class UserConsentRepository implements RepoContract {
    ...
    public function insert(array $row): void {
        ...
        $tblEsc  = $isMysql ? '`user_consents`' : '"user_consents"';
     ...
     * [ 'user_id', 'consent_type', 'version' ] = unikátní klíče (sloupce) pro konflikty,
     * [ 'granted', 'granted_at', 'source', 'meta' ] = které sloupce aktualizovat.
     */
    public function upsert(array $row): void {
        ...
        $upd  = [ 'granted', 'granted_at', 'source', 'meta' ];
