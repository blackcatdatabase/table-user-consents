...
final class Repository
{
    ...
    {
        $this->repo = new UserConsentRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\UserConsents\Dto\UserConsentDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\UserConsents\Dto\UserConsentDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\UserConsents\Dto\UserConsentDto|null
    {
